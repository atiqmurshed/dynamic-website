...
//show catagories load function 100;
function getTimeString(time){
    const hour = parseInt(time / 3600);
    let reaminingSecond = time % 3600;
    const minute = parseInt(reaminingSecond / 60);
    reaminingSecond = reaminingSecond % 60;
    return `${hour} hour ${minute} minute ${reaminingSecond} second ago`;
}
...
//show display categories function;
